    ...
    axios
      ...
      .catch((err) => {
        ...
        if (err.response.data === 'email') {
          ...
          toast.error('A problem was encountered while attempting to create your new account. Please try again later.');
        }
      });
  };
    ...
    axios
      ...
      .catch((err) => {
        ...
        if (err.response.data === 'userCreds') {
          ...
          toast.error('There was an error while attempting to log you in to your account. Please try again later.');
      });
  };
